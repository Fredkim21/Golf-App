...
import { Box, Theme, CssMixBlendMode, Dimensions, ModernMotionProps, PropertyAccessor, ValueFormat, ClosedCurveFactoryId, DotsItemSymbolComponent, SvgDefsAndFill } from '@nivo/core';
...
export declare type GridLabelComponent = FunctionComponent<GridLabelProps>;
...
export declare type RadarSliceTooltipComponent = FunctionComponent<RadarSliceTooltipProps>;
...
export declare type RadarCustomLayer<D extends Record<string, unknown>> = FunctionComponent<RadarCustomLayerProps<D>>;
export declare type RadarLayerId = 'grid' | 'layers' | 'slices' | 'dots' | 'legends';
export declare type RadarColorMapping = Record<string, string>;
...
export declare type RadarSvgProps<D extends Record<string, unknown>> = Partial<RadarCommonProps<D>> & RadarDataProps<D> & Dimensions & ModernMotionProps & SvgDefsAndFill<RadarSvgFillMatcherDatum<D>>;
export declare type BoundLegendProps = Required<Pick<LegendProps, 'data'>> & Omit<LegendProps, 'data'>;
